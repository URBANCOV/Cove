...
const Hero: React.FC = () => {
  return (
    <section id="home" className="relative min-h-screen flex items-center pt-20 overflow-hidden">
      ...
      <div className="w-full mx-auto px-6 md:px-12 lg:px-24 max-w-[1600px] relative z-20 min-h-screen flex items-end pb-32 md:pb-48">
        <div className="max-w-xs md:max-w-sm">
          ...
          >
            <a
              href="#contact"
              className="inline-flex items-center justify-center px-8 py-3.5 text-sm font-bold text-black bg-white rounded-full hover:bg-gray-200 transition-all duration-300 ease-out transform-gpu hover:scale-105 active:scale-95 shadow-[0_0_15px_rgba(255,255,255,0.3)] hover:shadow-[0_0_25px_rgba(255,255,255,0.5)]"
            >
              Schedule Call
            </a>
          </motion.div>
