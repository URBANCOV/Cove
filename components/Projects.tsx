        ...
        >
          <div className="flex items-center gap-6">
            <button 
              ...
              className={`text-sm md:text-base font-medium transition-all ${filter === 'All' ? 'text-white [text-shadow:0_0_10px_rgba(255,255,255,0.5)]' : 'text-gray-500 hover:text-gray-300 hover:[text-shadow:0_0_8px_rgba(255,255,255,0.3)]'}`}
            >
              All
            </button>
            <button 
              onClick={() => setFilter('Real Project')}
              className={`text-sm md:text-base font-medium transition-all ${filter === 'Real Project' ? 'text-white [text-shadow:0_0_10px_rgba(255,255,255,0.5)]' : 'text-gray-500 hover:text-gray-300 hover:[text-shadow:0_0_8px_rgba(255,255,255,0.3)]'}`}
            >
              Real Project
            </button>
            <button 
              onClick={() => setFilter('Exploration')}
              className={`text-sm md:text-base font-medium transition-all ${filter === 'Exploration' ? 'text-white [text-shadow:0_0_10px_rgba(255,255,255,0.5)]' : 'text-gray-500 hover:text-gray-300 hover:[text-shadow:0_0_8px_rgba(255,255,255,0.3)]'}`}
            >
              Exploration
            </button>
          </div>
