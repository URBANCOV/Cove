      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="flex flex-col justify-between h-full">
          ...
          >
            ...
            <h1 className="text-4xl sm:text-5xl md:text-7xl font-bold text-white mb-2 tracking-tight leading-[1.1]">Let's Talk</h1>
            <h2 className="text-2xl sm:text-3xl md:text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-gray-200 to-gray-500 leading-[1.1]">and Build Together.</h2>
          </motion.div>
        </div>

        {/* Right Side - Form */}
        <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-6 sm:p-8 md:p-10 shadow-2xl w-full relative overflow-hidden">
          {isSuccess ? (
          ...
          >
            {/* Name Group */}
            <motion.div variants={{ hidden: { opacity: 0, x: 30 }, visible: { opacity: 1, x: 0, transition: { duration: 0.8, ease: [0.22, 1, 0.36, 1] } } }} className="border border-white/10 bg-black/20 rounded-xl p-5 flex flex-col sm:flex-row gap-6 sm:gap-8">
