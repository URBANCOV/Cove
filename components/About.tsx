    ...
    <SectionWrapper id="about">
      <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
        ...
        <motion.div 
          ...
          className="grid grid-cols-2 gap-x-4 sm:gap-x-8 gap-y-12 sm:gap-y-16 mt-8 lg:mt-0"
        >
          {/* Stat 1 */}
          <motion.div variants={{ hidden: { opacity: 0, y: 30 }, visible: { opacity: 1, y: 0, transition: { duration: 0.8, ease: [0.22, 1, 0.36, 1] } } }}>
            <div className="flex items-start mb-4">
              <h3 className="text-5xl sm:text-6xl md:text-7xl lg:text-[7rem] font-medium text-white tracking-tighter leading-none">10</h3>
          ...
          <motion.div variants={{ hidden: { opacity: 0, y: 30 }, visible: { opacity: 1, y: 0, transition: { duration: 0.8, ease: [0.22, 1, 0.36, 1] } } }}>
            <div className="flex items-start mb-4">
              <h3 className="text-5xl sm:text-6xl md:text-7xl lg:text-[7rem] font-medium text-white tracking-tighter leading-none">500</h3>
              <span className="text-3xl md:text-4xl lg:text-5xl text-white font-light ml-1">+</span>
            </div>
            <p className="text-gray-400 text-sm md:text-base leading-relaxed max-w-[200px]">
          ...
          <motion.div variants={{ hidden: { opacity: 0, y: 30 }, visible: { opacity: 1, y: 0, transition: { duration: 0.8, ease: [0.22, 1, 0.36, 1] } } }}>
            <div className="flex items-start mb-4">
              <h3 className="text-5xl sm:text-6xl md:text-7xl lg:text-[7rem] font-medium text-white tracking-tighter leading-none">3</h3>
              <span className="text-3xl md:text-4xl lg:text-5xl text-white font-light ml-1">+</span>
            </div>
            <p className="text-gray-400 text-sm md:text-base leading-relaxed max-w-[200px]">
          ...
          <motion.div variants={{ hidden: { opacity: 0, y: 30 }, visible: { opacity: 1, y: 0, transition: { duration: 0.8, ease: [0.22, 1, 0.36, 1] } } }}>
            <div className="flex items-start mb-4">
              <h3 className="text-5xl sm:text-6xl md:text-7xl lg:text-[7rem] font-medium text-white tracking-tighter leading-none">100</h3>
              <span className="text-3xl md:text-4xl lg:text-5xl text-white font-light ml-1">%</span>
            </div>
            <p className="text-gray-400 text-sm md:text-base leading-relaxed max-w-[200px]">
